...
export default function Sidebar({ materialsCount }: SidebarProps) {
  ...
  return (
    <div className={`${isOpen ? 'w-56' : 'w-16'} bg-white border-r border-gray-200 h-screen sticky top-0 flex flex-col transition-all duration-300 ease-in-out`}>
      {/* Logo Section */}
      <div className="p-4 border-b border-gray-200 flex items-center justify-between">
        ...
        <button
          ...
          className={`p-1.5 rounded-md hover:bg-gray-100 transition-colors ${!isOpen ? 'w-full flex justify-center' : ''}`}
        ...
        {navigationItems.map((item) => {
          ...
          return (
            <button
              ...
              className={`w-full flex items-center ${isOpen ? 'gap-2.5 px-3' : 'justify-center px-2'} py-2 rounded-md transition-all text-left text-sm relative group ${
                active
        ...
        {isOpen ? (
          ...
          <div className="flex flex-col items-center gap-2">
            ...
            <button
              onClick={handleLogout}
              disabled={isLoggingOut}
              className="p-2 text-red-600 bg-red-50 rounded-md hover:bg-red-100 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
